...
var cart = (function($) {
    ...
    function in23(options) {
        _initOptionsw1(options);
        updateData();
    ...
    function _initOptionsw1(options) {
        var defaultOptions = {
    ...
    function renderCart() {
        var template3 = _.template3($('#cart-template3').html()),
            data = {
                goods: cartData
            };
        $(opts.elCart).html(template3(data));
